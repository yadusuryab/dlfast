...
export const faq = [
  ...
  },
  {
    ...
    answer:
      "Sure! Photos, Videos, Reels, and IGTV can be downloaded from Instagram for free. FastDl supports only Instagram, and other sources are not supported.",
  },
  {
    question: "How to Download Instagram Photos and Videos Online?",
    answer:
      "1.Copy an Instagram video or photo URL 2.Go back to FastDl and paste it into the field, and press Download 3.Shortly, you will see the results, pick the quality you need, and download.",
  },
  {
    ...
    <div className="my-10">
      ...
      <div className="header">
        ...
        <p className="text-muted-foreground">
          ...
          the fastdl.app downloader. If you can't find the answer to your
