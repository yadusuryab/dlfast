    ...
    <div className="md:px-64 px-10 block mx-auto my-5">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            FastDl is an online web tool that helps you download Instagram
            Videos, Photos, Reels, and IGTV. FastDl is designed to be easy to
            use on any device, such as a mobile phone, tablet, or computer.
          </CardDescription>
        </CardHeader>
      </Card>
      <div className="how-to my-10">
      ...
      <div className="features">
        <div className="header">
          <h2 className="text-lg font-semibold">
            Choose FastDL for download from Instagram
          </h2>
          <p className="text-muted-foreground">
        ...
        <div className="content grid md:grid-cols-2 gap-5 grid-cols-1 place-items-center">
          <StepCard
            ...
            title="Fast download"
            description="Our servers are optimized to provide you with the fastest
                download speeds."
          />
          <StepCard
            className=""
      ...
      <div className="about">
        <div className="header">
          ...
          <p className="text-muted-foreground">
            With FastDl you can download any type of content from Instagram. Our
            service has an IG video downloader, Reels, IGTV, photo or carousel.
          </p>
        </div>
        <div>
          <StepCard
